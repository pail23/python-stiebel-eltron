...
class WpmStiebelEltronAPI(StiebelEltronAPI):
    ...
    def __init__(self, host: str, port: int = 502, slave: int = 1) -> None:
        super().__init__([
                ...
                ModbusRegisterBlock(base_address=500, count=112, name="System Values", registers=WPM_SYSTEM_VALUES_REGISTERS),
                ModbusRegisterBlock(base_address=500, count=112, name="Energy System Information", registers=WPM_ENERGY_SYSTEM_INFORMATION_REGISTERS),
            ], 
            host, port, slave)