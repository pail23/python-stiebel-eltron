...
env = Environment(loader=FileSystemLoader(str(scripts_path / "templates")), autoescape=select_autoescape())
env.globals.update(python_name=python_name, python_class_name=python_class_name, float_or_none=float_or_none)
