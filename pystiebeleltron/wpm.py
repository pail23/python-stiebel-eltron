...
class WpmSystemParameters(Component):
    ...
    comfort_temperature_hp_1 = gauge(1501, 0.1, nan=UNAVAILABLE, unit="°C", writable=in_range(5, 30))
    eco_temperature_hp_1 = gauge(1502, 0.1, nan=UNAVAILABLE, unit="°C", writable=in_range(5, 30))
    heating_curve_rise_hp_1 = gauge(1503, 0.01, nan=UNAVAILABLE, writable=in_range(0, 3))
    comfort_temperature_hp_2 = gauge(1504, 0.1, nan=UNAVAILABLE, unit="°C", writable=in_range(5, 30))
    eco_temperature_hp_2 = gauge(1505, 0.1, nan=UNAVAILABLE, unit="°C", writable=in_range(5, 30))
    heating_curve_rise_hp_2 = gauge(1506, 0.01, nan=UNAVAILABLE, writable=in_range(0, 3))
    ...
    comfort_temperature_hp_3 = gauge(1550, 0.1, nan=UNAVAILABLE, unit="°C", writable=in_range(5, 30))
    eco_temperature_hp_3 = gauge(1551, 0.1, nan=UNAVAILABLE, unit="°C", writable=in_range(5, 30))
    heating_curve_rise_hp_3 = gauge(1552, 0.01, nan=UNAVAILABLE, writable=True)
    comfort_temperature_hp_4 = gauge(1553, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    eco_temperature_hp_4 = gauge(1554, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    heating_curve_rise_hp_4 = gauge(1555, 0.01, nan=UNAVAILABLE, writable=True)
    comfort_temperature_hp_5 = gauge(1556, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    eco_temperature_hp_5 = gauge(1557, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    heating_curve_rise_hp_5 = gauge(1558, 0.01, nan=UNAVAILABLE, writable=True)
    set_temperature_cc_1_hp_1 = gauge(1603, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_temperature_cc_2_hp_2 = gauge(1604, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_temperature_cc_3_hp_3 = gauge(1605, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_temperature_cc_4_hp_4 = gauge(1606, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_temperature_cc_5_hp_5 = gauge(1607, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_flow_temperature_cc_1_hp_1 = gauge(1703, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_flow_temperature_cc_2_hp_2 = gauge(1704, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_flow_temperature_cc_3_hp_3 = gauge(1705, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_flow_temperature_cc_4_hp_4 = gauge(1706, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
    set_flow_temperature_cc_5_hp_5 = gauge(1707, 0.1, nan=UNAVAILABLE, unit="°C", writable=True)
