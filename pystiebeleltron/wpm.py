...
class WpmSystemState(Component):
    ...
    heating_circuit_pump_1 = boolean(2508, nan=UNAVAILABLE)
    heating_circuit_pump_2 = boolean(2509, nan=UNAVAILABLE)
    heating_circuit_pump_3 = boolean(2510, nan=UNAVAILABLE)
    buffer_charging_pump_1 = boolean(2511, nan=UNAVAILABLE)
    buffer_charging_pump_2 = boolean(2512, nan=UNAVAILABLE)
    dhw_charging_pump = boolean(2513, nan=UNAVAILABLE)
    source_pump = boolean(2514, nan=UNAVAILABLE)
    fault_output = boolean(2515, nan=UNAVAILABLE)
    dhw_circulation_pump = boolean(2516, nan=UNAVAILABLE)
    we_2_dhw = boolean(2517, nan=UNAVAILABLE)
    we_2_heating = boolean(2518, nan=UNAVAILABLE)
    cooling_mode = boolean(2519, nan=UNAVAILABLE)
    mixer_open_hc2 = boolean(2520, nan=UNAVAILABLE)
    mixer_close_hc2 = boolean(2521, nan=UNAVAILABLE)
    mixer_open_hc3 = boolean(2522, nan=UNAVAILABLE)
    mixer_close_hc3 = boolean(2523, nan=UNAVAILABLE)
    nhz_1 = boolean(2524, nan=UNAVAILABLE)
    nhz_2 = boolean(2525, nan=UNAVAILABLE)
    nhz_1_2 = boolean(2526, nan=UNAVAILABLE)
    heating_circuit_pump_4 = boolean(2527, nan=UNAVAILABLE)
    heating_circuit_pump_5 = boolean(2528, nan=UNAVAILABLE)
    buffer_charging_pump_3 = boolean(2529, nan=UNAVAILABLE)
    buffer_charging_pump_4 = boolean(2530, nan=UNAVAILABLE)
    buffer_charging_pump_5 = boolean(2531, nan=UNAVAILABLE)
    buffer_charging_pump_6 = boolean(2532, nan=UNAVAILABLE)
    diff_controller_pump_1 = boolean(2533, nan=UNAVAILABLE)
    diff_controller_pump_2 = boolean(2534, nan=UNAVAILABLE)
    pool_pump_primary = boolean(2535, nan=UNAVAILABLE)
    pool_pump_secondary = boolean(2536, nan=UNAVAILABLE)
    mixer_open_hc4 = boolean(2537, nan=UNAVAILABLE)
    mixer_close_hc4 = boolean(2538, nan=UNAVAILABLE)
    mixer_open_hc5 = boolean(2539, nan=UNAVAILABLE)
    mixer_close_hc5 = boolean(2540, nan=UNAVAILABLE)
    compressor_1 = boolean(2541, nan=UNAVAILABLE)
    compressor_2 = boolean(2542, nan=UNAVAILABLE)
    compressor_3 = boolean(2543, nan=UNAVAILABLE)
    compressor_4 = boolean(2544, nan=UNAVAILABLE)
    compressor_5 = boolean(2545, nan=UNAVAILABLE)
    compressor_6 = boolean(2546, nan=UNAVAILABLE)
...
class WpmExtendedSystemValues(Component):
...
class WpmStiebelEltronAPI:
    ...
    def __init__(self, unit: ModbusUnit) -> None:
        ...
        self.extended_system_values = WpmExtendedSystemValues(unit)
